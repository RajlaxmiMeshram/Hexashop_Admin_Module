...
<head>
 ...
 <?php
   ...
   $name = $email = $gender = $comment =  $pass = $sellerid = "";
...
$sql = "UPDATE add_sellers SET s_name = '".$name."',s_email='".$email."',s_gender='".$gender."',s_city='".$city ."' where  s_id = '".$sellerid ."' ";
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" value="<?php echo $name;?>" id="exampleInputName1" placeholder="Name">
                      
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Email address</label>&nbsp<span style="color:red;" class="error">* <?php echo $emailErr;?></span> <br><br>
                      <input type="email" class="form-control" name="email" value="<?php echo $email;?>"id="exampleInputEmail3" placeholder="Email">
