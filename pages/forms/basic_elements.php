            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4>Add Products</h4>
                    <p class="card-description">Products</p>
                    <p><span class="error" style="color:red;" >* required field</span></p>
                    <form class="forms-sample" method="post" action="#">
                      <div class="form-group">
                        <label for="exampleInputName1">Product Name</label>&nbsp <span style="color:red;" class="error">* <?php echo $nameErr;?></span><br><br>
                      ...
                      <div class="form-group">
                        <label >Brands</label><span style="color:red;" class="error">* <?php echo $brandErr;?></span>
                        ...
                        > <option value="">select an option</option>
                          ...
                          <option value="3">109F</option>
                          <option value="4">AARA</option>
                          <option value="5">ADIDAS</option>
                          <option value="6">Allen Solly</option>
                          <option value="7">Forever21</option>
                        </select>
                      </div>

                      <div class="form-group" name="size"  value="<?php echo $sizes;?>">
               ...
               <label>File upload</label><br>                      
                        ...
                        />
                          ...
                          <div class="form-group row">
                      <label  for="exampleSelectstock" style="font: size 50px;" >Stock:</label>&nbsp <span style="color:red;"  class="error">* <?php echo $stockerr;?></span><br><br>
                        <br>
                        &nbsp&nbsp&nbsp<input type="radio" name="stock" <?php if (isset($stock) && $stock=="yes") echo "checked";?> value="yes"> &nbsp&nbsp&nbsp Yes &nbsp &nbsp
           <input type="radio" name="stock" <?php if (isset($stock) && $stock=="no") echo "checked";?> value="no">No
